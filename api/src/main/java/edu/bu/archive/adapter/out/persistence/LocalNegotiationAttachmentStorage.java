...
/**
 * Local-dev stand-in for {@link S3NegotiationAttachmentStorage}: reads
...
public class LocalNegotiationAttachmentStorage
        implements NegotiationAttachmentStorage {

    private final Path baseDirectory;
    private final String localBucket;

    public LocalNegotiationAttachmentStorage(
