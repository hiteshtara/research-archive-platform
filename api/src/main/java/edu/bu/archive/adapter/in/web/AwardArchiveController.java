...
/*
 * Legacy, unversioned Award endpoints - still consumed directly by the
 * current React UI (ui/src/api/client.ts). New endpoints go on
 * AwardV1Controller (/api/v1/awards) instead of here - see
 * docs/architecture/AWARD_SEARCH_API_DESIGN.md's "API versioning"
 * section for why this controller is intentionally not migrated to
 * /api/v1 in the same pass.
 */
@RestController
