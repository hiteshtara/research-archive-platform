/*
 * Protocol unit export.
 *
 * PROTOCOL_PERSON_ID is the verified physical parent relationship (see
 * archive_etl/pipeline/protocol_parent_resolution.py's OWNER_CHAIN
 * resolution). Protocol number and sequence are retained for audit only,
 * not as independent parent keys.
 */
SELECT
