...
RERUN_COMMAND_BY_DOMAIN = {
    ...
    "PROTOCOL_CORE": "uv run python load_protocols_from_csv.py",
    "PROTOCOL_ACTION": "uv run python load_protocol_actions.py",
    "PROTOCOL_AMEND_RENEWAL": "uv run python load_protocol_amend_renewals.py",
    "PROTOCOL_LOCATION": "uv run python load_protocol_locations.py",
    "PROTOCOL_RESEARCH_AREA": "uv run python load_protocol_research_areas.py",
    "PROTOCOL_PERSONNEL": "uv run python load_protocol_personnel.py",
    "PROTOCOL_FUNDING": "uv run python load_protocol_funding.py",
    "PROTOCOL_SUBMISSION": "uv run python load_protocol_submissions.py",
