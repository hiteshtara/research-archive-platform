    ...
    def test_load_award_id_short_circuits_full_load(self) -> None:
        with (
            ...
            parse_args.return_value = MagicMock(
                ...
                load_unit_reference_data=False,
                load_comment_type_reference_data=False,
                load_custom_attribute_reference_data=False,
                load_terms_reference_data=False,
                load_sponsor_reference_data=False,
                dry_run=False,
                ecs=False,
                migrate_only=False,
            )
